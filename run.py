...
def parse_arguments():
    ...
    parser.add_argument('--audio_semantic_feats_path', type=str, default='audio_patch_feats.pkl', help="The directory of the audio semantic features.")

    parser.add_argument('--video_semantic_feats_path', type=str, default='video_patch_feats.pkl', help="The directory of the video semantic features.")
